...
(deftype Vec2
       ...
       g/PBuffered
       (get-buffer [_] buf)
       (copy-to-buffer [_ dest stride idx] (.set dest buf idx) (+ idx stride))
...
(madd [_ a b]  (vm/v3-op2                             (new js/Float32Array) * + buf a b 0.0 0.0 _meta))
(addm [_ a b]  (vm/v3-op2                             (new js/Float32Array) + * buf a b 0.0 0.0 _meta))
(msub [_ a b]  (vm/v3-op2                             (new js/Float32Array) * - buf a b 0.0 0.0 _meta))
(subm [_ a b]  (vm/v3-op2                             (new js/Float32Array) - * buf a b 0.0 0.0 _meta))
