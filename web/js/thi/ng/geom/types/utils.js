...
var vec__24641 = thi.ng.geom.core.utils.bounding_rect(points);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24641,(0),null);
var size = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24641,(1),null);
...
var vec__24643 = thi.ng.geom.core.utils.bounding_box(points);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24643,(0),null);
var size = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24643,(1),null);
if(cljs.core.truth_(p)){
...
var vec__24646 = thi.ng.geom.core.utils.radial_bounds(thi.ng.geom.core.vector.vec2,c,r_or_points);
var c__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24646,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24646,(1),null);
...
var vec__24650 = thi.ng.geom.core.utils.radial_bounds(thi.ng.geom.core.vector.vec3,c,r_or_points);
var c__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24650,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24650,(1),null);
...
return thi.ng.geom.core.scale_size(thi.ng.geom.core.center.cljs$core$IFn$_invoke$arity$2(p1__24652_SHARP_,thi.ng.geom.core.unmap_point(b_SINGLEQUOTE_,thi.ng.geom.core.map_point(b,thi.ng.geom.core.centroid(p1__24652_SHARP_)))),s);
});})(b,s,b_SINGLEQUOTE_))
,coll);
});
thi.ng.geom.types.utils.into_mesh = (function thi$ng$geom$types$utils$into_mesh(mesh,add_face,mesh_or_faces){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(add_face,mesh,(((function (){var G__24654 = mesh_or_faces;
if(G__24654){
...
return G__24654.thi$ng$geom$core$PFaceAccess$;
}
})())){
return true;
} else {
if((!G__24654.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(thi.ng.geom.core.PFaceAccess,G__24654);
} else {
return false;
}
}
...
var tx__$1 = (((function (){var G__24659 = tx;
if(G__24659){
var bit__13281__auto__ = null;
if(cljs.core.truth_((function (){var or__12607__auto__ = bit__13281__auto__;
if(cljs.core.truth_(or__12607__auto__)){
...
return G__24659.thi$ng$geom$core$PVectorTransform$;
}
})())){
return true;
} else {
if((!G__24659.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(thi.ng.geom.core.PVectorTransform,G__24659);
} else {
return false;
}
}
...
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(acc,v,(function (){var G__24660 = v;
return (tx__$1.cljs$core$IFn$_invoke$arity$1 ? tx__$1.cljs$core$IFn$_invoke$arity$1(G__24660) : tx__$1.call(null,G__24660));
})());
});})(tx__$1))
...
var G__24661 = mesh__$1;
var G__24662 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(verts_SINGLEQUOTE_,f);
return (add_face.cljs$core$IFn$_invoke$arity$2 ? add_face.cljs$core$IFn$_invoke$arity$2(G__24661,G__24662) : add_face.call(null,G__24661,G__24662));
